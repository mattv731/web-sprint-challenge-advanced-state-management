...
It keeps us from having to do prop drilling.

2. In your own words, describe `actions`, `reducers` and the `store` and their role in Redux. What does each piece do? Why is the store known as a 'single source of truth' in a redux application?

Actions are a piece of data manipulation in a reducer pattern. Reducers are a way to keep state data more predictable. Store allows us to use the reducer
as well as other middleware functions.

3. What does `redux-thunk` allow us to do? How does it change our `action-creators`?

It allows us to make API calls because it allows asynchronous actions.

4. What is your favorite state management system you've learned and this sprint? Please explain why!

I like redux simply because it is the industry standard. I am all for learning what I am most likely to use.
